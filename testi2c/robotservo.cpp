...
const int pwm_centre_pca=0x139;
const double pwm_angle_ratio_pca=2.1222222222222222222222222222222;
int pwminitvalue[16]={0,0,0,0,0,0,30,0,0,0,0,0,0};
...
unsigned char cmdh;
int tmp;
tmp=round(pwm_centre_pca+pwm_angle_ratio_pca*angle);
cmd=tmp;
cmdl=cmd&0xff;
cmdh=(cmd>>8)&0x0f;
